...
<v-container class="mx-auto" grid-list-xs>
  ...
  <form>
    <v-text-field v-model="firstName" :error-messages="firstNameErrors" label="First Name" required
      @input="$v.firstName.$touch()" @blur="$v.firstName.$touch()"></v-text-field>

    <v-text-field v-model="lastName" :error-messages="lastNameErrors" label="Last Name" required
    ...
    <v-select v-model="selected" :hint="`${selected.name}, ${selected.code}`" :items="codes" item-text="name"
      item-value="code" label="Select" persistent-hint return-object single-line @change="onChange"></v-select>
