<template>
  <v-container class="mx-auto">
    ...
    <v-text-field name="pickup" label="Pick Up point" id="pickup"></v-text-field>
    <v-text-field name="destination" label="Destination" id="destination"></v-text-field>
    <v-row class="mx-auto">
    ...
    <v-text-field name="selectVeh" label="Select Vehical" id="selectVeh"></v-text-field>

    <v-select :items="seats" v-model="value" label="No. of Seats"></v-select>
    ...
    <v-btn color="info">Publish</v-btn>
  </v-container>
</template>
